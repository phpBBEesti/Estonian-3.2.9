...
$lang = array_merge($lang, array(
	...
	'BOOL_TYPE_EXPLAIN'		=> 'Määra tüüp, kas valikukast või raadionupp. Valikukast kuvatakse vaid siis, kui see on kasutajal valitud. Sel juhul kasutatakse <strong>teist</strong> keelevalikut. Raadionupud kuvatakse sõltumata nende väärtusest.',
	...
	'FIELD_INT'					=> 'Numbrid',
	'FIELD_IS_CONTACT'			=> 'Näita välja kontakti väljana',
	...
	'HIDE_PROFILE_FIELD_EXPLAIN'	=> 'Peidab profiilivälja teiste kasutajate eest v.a. administraatorite ja moderaatorite eest, kes saavad seda välja endiselt näha. Kui juhtpaneelis kuvamise valik on keelatud, ei saa kasutaja näha ega muuta seda välja, seda saavad teha vaid administraatorid.',
	...
	'LETTER_NUM_DOTS'			=> 'Kõik kirjamärgid, numbrid ja punktid (perioodiline)',
	'LETTER_NUM_ONLY'			=> 'Kõik kirjamärgid ja numbrid',
	'LETTER_NUM_PUNCTUATION'	=> 'Kõik kirjamärgid, numbrid, komad, punktid, alakriipsud ja kriipsud beginning with any letter',
	'LETTER_NUM_SPACERS'		=> 'Kõik kirjamärgid, numbrid ja tühikud',
	'LETTER_NUM_UNDERSCORE'		=> 'Kõik kirjamärgid, numbrid ja alakriipsud',
	...
	'STEP_2_EXPLAIN_EDIT'			=> 'Siin saad muuta mõningaid tavalisi valikuid.<br /><strong>Profiilivälja muudatused ei mõjuta praeguseid profiilivälju, mida kasutajad on täitnud.</strong>',
	'STEP_2_TITLE_CREATE'			=> 'Profiili tüübi põhised valikud',
	'STEP_2_TITLE_EDIT'				=> 'Profiili tüübi põhised valikud',
	'STEP_3_EXPLAIN_CREATE'			=> 'Kuna sul on foorumis rohkem kui üks keel, pead täitma ka ülejäänud keelevalikud. Profiiliväli töötab vaikimisi valitud keelega, Saad muuta ülejäänud keeleobjekte ka hiljem.',
	'STEP_3_EXPLAIN_EDIT'			=> 'Kuna sul on foorumis rohkem kui üks keel, pead muutma või lisama nüüd ka ülejäänud keelevalikud. Profiiliväli töötab vaikimisi valitud keelega.',
	'STEP_3_TITLE_CREATE'			=> 'Ülejäänud keeleobjektid',
	'STEP_3_TITLE_EDIT'				=> 'Keeleobjektid',
	'STRING_DEFAULT_VALUE_EXPLAIN'	=> 'Sisesta kuvatav vaikimisi fraas, vaikeväärtus. Jäta tühjaks, kui soovid selle kuvada tühjana.',

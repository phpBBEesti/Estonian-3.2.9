...
$lang = array_merge($lang, array(
	...
	'BOARD_INDEX_TEXT'				=> 'Foorumi pealehe lingi tekst',
	'BOARD_INDEX_TEXT_EXPLAIN'		=> 'Seda teksti näidatakse foorumi esilehe tekstina foorumi breadcrumb\'s. Kui jätta tühjaks, siis näidatakse automaatselt vaikimisi teksti “Foorumi pealeht”.',
	'BOARD_STYLE'					=> 'Foorumi stiil',
	'CUSTOM_DATEFORMAT'				=> 'Kohandatud…',
	'DEFAULT_DATE_FORMAT'			=> 'Ajaformaat',
	'DEFAULT_DATE_FORMAT_EXPLAIN'	=> 'Kuupäeva vorming on sama mis PHP funktsioonil <code><a href="https://secure.php.net/manual/function.date.php">date()</a></code>.',
	...
	'DISPLAY_LAST_SUBJECT'			=> 'Kuva viimase postituse teema pealkirja esilehel',
	'DISPLAY_LAST_SUBJECT_EXPLAIN'	=> 'Pealkirja teemast, kuhu on lisatud viimati postitus kuvatakse foorumite nimekirjas lingina. Pealkirjad, mis on pärit parooliga kaitstud foorumitest ja foorumid kus liikmetel ei ole lugemisõigusi nimekirjas ei näidata.',
	...
	'SITE_HOME_TEXT'				=> 'Peamise veebilehe lingi tekst',
	'SITE_HOME_TEXT_EXPLAIN'		=> 'Seda teksti näidatakse lingina sinu üldisele veebilehele foorumi breadcrumb\'is. Kui pole täpsustatud, siis vaikimisi on selle nimeks “Kodu”. Näiteks: foorum.sinudomeen.ee peamise veebilehe domeen on sinudomeen.ee.',
...
$lang = array_merge($lang, array(
	...
	'ALLOW_BOARD_NOTIFICATIONS' => 'Luba foorumi teated',
));
...
$lang = array_merge($lang, array(
	...
	'ALLOW_AVATARS_EXPLAIN'			=> 'Luba avataride üldkasutus. Kui keelad kas kõik või osad avatarid, ei kuvata neid foorumil, kuid kasutajatel on siiski võimalus juhtpaneelis avatare laadida.',
	'ALLOW_GRAVATAR'				=> 'Luba gravatar avatarid',
	'ALLOW_LOCAL'					=> 'Luba avatarite galerii',
	'ALLOW_REMOTE'					=> 'Luba lingitud avatarid',
	'ALLOW_REMOTE_EXPLAIN'			=> 'Avatarid, mis on lingitud välistelt veebilehelt.<br><em><strong class="error">Hoiatus:</strong> Selle funktsiooni lubamine võimaldab kasutajatel kontrollida kas failid ja teenused on kättesaadavad ainult kohalikus võrgus.</em>',
	'ALLOW_REMOTE_UPLOAD'			=> 'Luba avataride üleslaadimine välistelt veebilehtedelt',
	'ALLOW_REMOTE_UPLOAD_EXPLAIN'	=> 'Luba avataride üleslaadimine teistelt veebilehtedelt.<br><em><strong class="error">Hoiatus:</strong> Selle funktsiooni lubamine võimaldab kasutajatel kontrollida kas failid ja teenused on kättesaadavad ainult kohalikus võrgus.</em>',
	'ALLOW_UPLOAD'					=> 'Luba avataride üleslaadimine',
	'AVATAR_GALLERY_PATH'			=> 'Avatari galerii tee',
	'AVATAR_GALLERY_PATH_EXPLAIN'	=> 'Tee sinu phpBB kaustas, kus on avataride galerii, nt. <samp>images/avatars/gallery</samp>. Topelt punktid, nagu näiteks <samp>../</samp> demonteeritakse teekonnast turvalisuse huvides.',
	'AVATAR_STORAGE_PATH'			=> 'Avataride üleslaadimiskaust',
	'AVATAR_STORAGE_PATH_EXPLAIN'	=> 'Tee sinu PhpBB kaustas, kuhu avatare üles laaditakse, nt. <samp>images/avatars/upload</samp>. Avatari üleslaadimine <strong>pole võimalik</strong>, kui see teekond ei ole kirjutatav. Topelt punktid nagu <samp>../</samp> demonteeritakse teekonnast turvalisuse huvides.',
	...
	'MAX_FILESIZE_EXPLAIN'			=> 'Maksimaalne avatari failisuurus üles laaditud avataridele. Kui selle väärtus on 0, siis üleslaaditud failisuurus on piiratud ainult sinu PHP seadest.',
...
$lang = array_merge($lang, array(
	...
	'ALLOWED_SCHEMES_LINKS'				=> 'Luba skeemide lingid',
	'ALLOWED_SCHEMES_LINKS_EXPLAIN'		=> 'Kasutajad saavad positada ainult skeemideta URL linke või ühte komaga eraldatud lubatud skeemi.',
	'ALLOW_POST_FLASH'					=> 'Luba <code>[FLASH]</code> BBkood märgendid postitustes',
	'ALLOW_POST_FLASH_EXPLAIN'			=> 'Kui see on keelatud <code>[FLASH]</code> BBkood märgend on postitustes keelatud. Kui on lubatud, saab kasutaja postitada flash\'i, kui tal on selleks õigused.',
	...
	'SMILIES_LIMIT_EXPLAIN'			=> 'Kui mitu emotikoni saab lisada ühte postitusse. Sisesta väärtus 0, piiramatu arv emotikonide jaoks.',
	'SMILIES_PER_PAGE'				=> 'Emotikonide arv ühe lehekülje kohta',
	'TOPICS_PER_PAGE'				=> 'Teemade arv ühe lehekülje kohta',
));
...
$lang = array_merge($lang, array(
	'ACP_REGISTER_SETTINGS_EXPLAIN'		=> 'See lehekülg on Sulle abiks seadistamaks oma foorumi registreerimise ja profiiliga seotuid sätteid.',
...
$lang = array_merge($lang, array(
	...
	'ACP_FEED_ENABLE_EXPLAIN'			=> 'Lülitab ATOM voogude kasutamise sisse või välja. Valiku keelamine lülitab välja kõik vood olenemata allolevatest valikutest.',
	...
	'ACP_FEED_TOPICS_ACTIVE_EXPLAIN'	=> 'Lubab “Aktiivsete teemade” vood, mis kuvab viimaseid aktiivseid teemasi koos viimase postitusega.',
	'ACP_FEED_NEWS'						=> 'Uudistevood',
	'ACP_FEED_NEWS_EXPLAIN'				=> 'Võta esimene postitus neist foorumitest. Ära vali ühtegi foorumit selle valiku keelamiseks. Vali mitu foorumit, kasutades <samp>CTRL</samp>-klahvi.',
	...
	'ACP_FEED_ITEM_STATISTICS_EXPLAIN'	=> 'Näita eraldi statistika üksuste all (Postitaja, kuupäev ja kellaaeg, vasutseid, vaatamisi)',
	'ACP_FEED_EXCLUDE_ID'				=> 'Jäta välja need foorumid',
	'ACP_FEED_EXCLUDE_ID_EXPLAIN'		=> 'Nende foorumite sisu <strong>ei näidata voogudes</strong>. Ära vali ühtegi foorumit, et voog võtaks andmed kõikidest foorumitest. Vali/vabasta mitu foorumit, kasutades <samp>CTRL</samp>-klahvi.',
));
...
// Cookie Settings
$lang = array_merge($lang, array(
	'ACP_COOKIE_SETTINGS_EXPLAIN'		=> 'Need seaded määravad küpsiste saatmise kasutajate brauseritesse. Enamikel juhtudel piisab küpsiste vaikeseadetest. Kui pead midagi muutma, tee seda hoolikalt, ebakorrektsed seaded võivad takistada kasutajate sisselogimist. Juhul, kui kasutajatel on probleeme, et nad ei jää sisselogituks foorumisse, siis palun külasta <strong><a href="https://www.phpbb.com/support/go/cookie-settings">phpBB.com õpetuste lehekülge - Kuidas parandada vigast küpsiste seadet</a></strong>',

	'COOKIE_DOMAIN'				=> 'Küpsise domeen',
	'COOKIE_DOMAIN_EXPLAIN'		=> 'Enamikel juhtudel on küpsiste domeen valikuline. Kui sa ei ole kindel, siis jäta tühjaks. Juhul, kui teil on foorum integreeritud koos mõne muu tarkvaraga või on mitu domeenit, siis määra samuti ära ka küpsiste domeen. Kui sul on näiteks midagi taolist <i>phpbbeesti.net</i>, ning <i>foorumid.phpbbeesti.net</i> või ehk <i>foorumid.phpbbeesti.net</i> and <i>blogi.phpbbeesti.net</i>. Eemalda alamdomeenid, kuniks leiad tavalise domeeni <i>phpbbeesti.net</i>. Nüüd aga lisa punkt otse oma tavalise domeeni ette, ning sa sisestad selle selliselt .phpbbeesti.net (pane tähele, et punkt on ees).',
	'COOKIE_NAME'				=> 'Küpsise nimi',
	'COOKIE_NAME_EXPLAIN'		=> 'See võib olla ükskõik milline, kuid tee see originaalne ja samas lihtne. Niipea kui küpsiste seaded on muudetud, siis peaksid ka muutma küpsiste nime.',
	'COOKIE_NOTICE'				=> 'Küpsise teade',
	'COOKIE_NOTICE_EXPLAIN'		=> 'Kui lubaud, siis küpsiste teade kuvatakse kasutajatele, kui nad külastavad foorumit.',
	'COOKIE_PATH'				=> 'Küpsise tee',
	'COOKIE_PATH_EXPLAIN'		=> 'Pane tähele, et see on alati kaldkriips, see ei oma tähtsust mis sinu foorumi aadress on.',
...
// Contact Settings
$lang = array_merge($lang, array(
	'ACP_CONTACT_SETTINGS_EXPLAIN'		=> 'Sellel leheküljel on Sul võimalik seadistada phpBB poolt sisse ehitatud kontaktivormiga seotuid seadeid. Näiteks: lubada või keelata kontaktivormi näitamine; lisada oma soovitud tekst, mida näidatakse kontakt leheküljel.',

	'CONTACT_US_ENABLE'				=> 'Luba kontakt lehekülje näitamine foorumil',
	'CONTACT_US_ENABLE_EXPLAIN'		=> 'Kui lubad kontakti lehekülje näitamise, siis kasutajad saavad saada e-kirju foorumi administraatorile läbi kontaktivormi',

	'CONTACT_US_INFO'				=> 'Kuvatav informatsioon kontakt leheküljel',
	'CONTACT_US_INFO_EXPLAIN'		=> 'Siia sisestatud informatsioon kuvatakse foorumi kontakti leheküljel kasutajatele',
	'CONTACT_US_INFO_PREVIEW'		=> 'Kuvatava informatsiooni eelvaade',
	'CONTACT_US_INFO_UPDATED'		=> 'Informatsioon lehekülje kontakt jaoks on uuendatud.',
));

// Load Settings
$lang = array_merge($lang, array(
	'ACP_LOAD_SETTINGS_EXPLAIN'	=> 'Siin leheküljel on Sul võimalik lubada ja keelata mõningaid foorumi funktsioone mis vähendavad serveri tööd. Siiski,  enamikes serverites või jagatud veebimajutustes ei ole see vajalik tegevus.',
	...
	'ALLOW_LIVE_SEARCHES_EXPLAIN'	=> 'Kui lubatud, siis: users are provided with keyword suggestions as they type in certain fields throughout the board.',
	...
	'LOAD_USER_ACTIVITY_EXPLAIN'	=> 'Kuvab aktiivse teema/foorumi kasutaja juhtpaneelis (KUJ) ja profiilis. On soovitatav see valik keelata foorumites, kus on üle miljoni postituse.',
	'LOAD_USER_ACTIVITY_LIMIT'		=> 'Piirang kasutajate aktiivsete postitustele',
	'LOAD_USER_ACTIVITY_LIMIT_EXPLAIN'	=> 'Aktiivset teemat/foorumit ei näidata kui kasutajatel on rohkem antud arvust postitusi. Seadista 0, et keelata funktsiooni liimiit.',
	...
	'YES_ACCURATE_PM_BUTTON'			=> 'Luba PM nupp lehekülgedel',
	'YES_ACCURATE_PM_BUTTON_EXPLAIN'    => 'Salvesta loetud/lugemata teemade info. Kui see on keelatud, näevad külalised teemasid alati loetuna.',
    	'YES_ANON_READ_MARKING'			=> 'Luba teemade markeerimine külalistele',
	'YES_ANON_READ_MARKING_EXPLAIN'	=> 'Loetud/lugemata informatsioon külalistele. Kui see on keelatud, märgitakse postitused alati loetuks.',	
	...
	'YES_JUMPBOX'					=> 'Luba jumpbox\'i näitamine',
...
$lang = array_merge($lang, array(
	...
	'AUTH_PROVIDER_OAUTH_EXPLAIN'				=> 'Iga OAuth teenus nõuab unikaalset secret ja key\'d, et oleks võimalik ühendada välise serveriga. Need peavad olema saadaval, samas kohas kus sa registreerisid. Ükskõik millisel teenusel ei ole mõlemat key ja secret sisestatud, siis ei ole neid ka võimalik kasutada siin foorumis.',
	'AUTH_PROVIDER_OAUTH_KEY'					=> 'Võti',
	'AUTH_PROVIDER_OAUTH_TITLE'					=> 'OAuth',
	'AUTH_PROVIDER_OAUTH_SECRET'				=> 'Salajane',
	...
	'LDAP_PASSWORD_EXPLAIN'			=> 'Jäta tühjaks, et kasutada anonüümset sidumist. Muidu täida ära salasõna lahter järgnevale kasutajale. Vajalik Active Directory Servers´ite jaoks. <em><strong>HOIATUS:</strong> See salasõna säilitatakse tekstina andmebaasis ja on nähtav kõigile, kellel on sinu andmebaasi luba või näevad seda seadete lehte siin.</em>',
...
$lang = array_merge($lang, array(
	...
	'IP_LOGIN_LIMIT_USE_FORWARDED_EXPLAIN'	=> 'Selle asemel, et piirata logimiskatseid IP aadressi järgi, on need piiratud <var>X_FORWARDED_FOR</var> väärtuse järgi. <em><strong>Hoiatus:</strong> Luba see valik ainult siis, kui opereerid proxy serveri taga, mis seab usaldatavaid <var>X_FORWARDED_FOR</var> väärtusi.</em>',
	...
	'UPLOAD_CERT_VALID'				=> 'Kinnita üleslaaditud sertifikaat',
	'UPLOAD_CERT_VALID_EXPLAIN'		=> 'Kui lubatud, siis üleslaaditud sertifikaadid kinnitatakse. See nõuab CA bundle määratlemaks <samp>openssl.cafile</samp> või <samp>curl.cainfo</samp> sätteid sinu php.ini failis.',
));
...
$lang = array_merge($lang, array(
	...
	'EMAIL_FORCE_SENDER'			=> 'Jõudke e-posti aadressilt',
	'EMAIL_FORCE_SENDER_EXPLAIN'	=> 'See määrab <samp>Tagasi-tee</samp> e-posti aadressile selle asemel et kasutada kohalikku kasutajat ja serveri hostinime. See seade ei kehti SMTP-d kasutades.<br><em><strong>Hoiatus:</strong> Nõuab kasutajalt, et veebiserver käivituks nii, et see lisatakse usaldusväärsele kasutajale kofiguratsiooni kirja saatma.</em>',
	...
	'EMAIL_MAX_CHUNK_SIZE'			=> 'Maksimaalne lubatud e-posti saajate arv',
	'EMAIL_MAX_CHUNK_SIZE_EXPLAIN'	=> 'Vajadusel määrake see nii, et see ei ületaks maksimaalset adressaatide arvu, mida teie e-posti server ühe e-kirjaga lubab.',
	...
	'SEND_TEST_EMAIL'				=> 'Saada test e-kiri',
 	'SEND_TEST_EMAIL_EXPLAIN'		=> 'Siin saad saata test e-kirja oma e-postile, mille oled määranud kontol.',
	'SMTP_ALLOW_SELF_SIGNED'		=> 'Luba ise-allkirjastatud SSL sertifikaadid',
	'SMTP_ALLOW_SELF_SIGNED_EXPLAIN'=> 'Luba ühendused SMTP serveriga koos ise-allkirjastatud sertifikaatidega.<em><strong>Hoiatus:</strong> Lubades ise-allkirjastatud SSL sertifikaadid võib põhjustada tagajärgi tuvalisusele.</em>',
	...
	'SMTP_PASSWORD_EXPLAIN'			=> 'Sisesta parool vaid siis, kui SMTP server seda nõuab..<em><strong>HOIATUS:</strong> See parool salvestatakse lihttekstina andmebaasi, ning on nähtav kõigile kes pääsevad ligi sinu foorumi andmebaasile või sellele leheküljele.</em>',
	'SMTP_PLAIN'					=> 'PLAIN',
	...
	'SMTP_SERVER_EXPLAIN'			=> 'Ärge esitage protokolli (<samp>ssl://</samp> või <samp>tls://</samp>), välja arvatud juhul, kui teie e-posti host soovitab teil seda teha.',
	...
	'SMTP_VERIFY_PEER'				=> 'Kinnita SSL sertifikaat',
	'SMTP_VERIFY_PEER_EXPLAIN'		=> 'Nõuab SSL sertifikaadi kinnitust, mida kasutab SMTP server.<em><strong>Hoiatus:</strong> Ühendades peerid koos mitte kinnitatud SSL sertifikaatidega võib põhjustada tagajärgi turvalisusele.</em>',
	'SMTP_VERIFY_PEER_NAME'			=> 'Kinnita SMTP peer nimi',
	'SMTP_VERIFY_PEER_NAME_EXPLAIN'	=> 'Nõuab nime kinnitust SMTP serveritelt, mis kasutab SSL / TLS ühendust.<em><strong>Hoiatus:</strong> Ühendades peerid koos mitte kinnitatud SSL sertifikaatidega võib põhjustada tagajärgi turvalisusele.</em>',
	'TEST_EMAIL_SENT'				=> 'Proovi e-kiri saadeti. Kui Sa ei saanud seda kätte, siis palun kontrolli oma e-posti seadeid. Kui vajad abi, siis külasta <a href="https://www.phpbb.com/community/">phpBB tugifoorumit</a>.',
...
$lang = array_merge($lang, array(
	...
	'JAB_ALLOW_SELF_SIGNED_EXPLAIN'	=> 'Luba ühendused Jabber serveriga koos ise-allkirjastatud SSL sertifikaatidega.<em><strong>Hoiatus:</strong> Ühendades peerid koos mitte kinnitatud SSL sertifikaatidega võib põhjustada tagajärgi turvalisusele.</em>',
	...
	'JAB_VERIFY_PEER_EXPLAIN'		=> 'Nõuab SSL sertifikaadi kinnitust, mida kasutatab Jabber server.<em><strong>Hoiatus:</strong> Ühendades peerid koos mitte kinnitatud SSL sertifikaatidega võib põhjustada tagajärgi turvalisusele.</em>',
	'JAB_VERIFY_PEER_NAME'			=> 'Määra Jabber peeri nimi',
	'JAB_VERIFY_PEER_NAME_EXPLAIN'	=> 'Nõuab peeri nimest kinnitust, Jabber serverite kasutamiseks SSL / TLS ühendustes.<em><strong>Hoiatus:</strong> Ühendades peerid koos mitte kinnitatud SSL sertifikaatidega võib põhjustada tagajärgi turvalisusele.</em>',
));

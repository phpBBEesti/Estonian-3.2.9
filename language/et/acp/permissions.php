...
$lang = array_merge($lang, array(
	'ACP_PERMISSIONS_EXPLAIN'	=> '
		...
		<p>Täpsema informatsiooni saamiseks kuidas määrata ja hallata õigusi oma foorumile, vaata lähemalt phpBB.com leheküljel <a href="https://www.phpbb.com/support/docs/en/3.2/ug/quickstart/permissions/">õiguste seadistamise kiirjuhendit</a>.</p>
	',
	...
	'ACP_FORUM_PERMISSIONS_EXPLAIN'				=> 'Siin saad muuta, millised kasutajad ja grupid pääsevad millistesse foorumitesse. Et määrata moderaatoreid või administraatoreid, kasuta vastavat lehte.',
	...
	'ACP_GROUPS_PERMISSIONS_EXPLAIN'			=> 'Siin saad määrata gruppide üldised õigused - kasutaja õigused, üldmoderaatori õigused ja administraatori õigused. Kasutajate õigused sisaldavad võimalusi nagu avataride kasutamine, privaatsõnumite saatmine jne; üldmoderaatori õigused postituste heakskiitmist, teemade haldamist, keeldude haldamist jne; viimaks administraatori õigused, näiteks õiguste muutmine, foorumite haldamine jne. Kasutajate õigusi peaks eraldi muutma harvadel juhtudel, eelistatum meetod on kasutaja gruppi määramine ja grupile õiguste andmine.',
	...
	'ROLE_DESCRIPTION_ADMIN_USERGROUP'		=> 'Saab hallata kasutajaid ja gruppe: saab muuta õigusi, seadeid, hallata keelde ja tiitleid.',
	...
	'ROLE_DESCRIPTION_FORUM_READONLY'		=> 'Saab lugeda foorumit, kuid ei saa postitada ega teha teemasid.',
	...
	'ROLE_DESCRIPTION_MOD_STANDARD'			=> 'Saab kasutada enamikke moderaatori võimalusi, kuid ei saa keelata ega muuta postituse autorit.',
	...
	'TRACE_GROUP_NEVER_TOTAL_NO'	=> 'Selle grupi foorumi õigused on määratud <strong>MITTE KUNAGI</strong> peale, millest saab uus koguväärtus, sest seda polnud veel määratud (määratud <strong>EI</strong> peale).',
	'TRACE_GROUP_NEVER_TOTAL_NO_LOCAL'	=> 'Selle grupi õigused sellele foorumile on määratud <strong>MITTE KUNAGI</strong> peale, millest saab uus koguväärtus, sest seda polnud veel määratud (määratud <strong>EI</strong> peale).',
	...
	'TRACE_GROUP_YES_TOTAL_NO'		=> 'Selle grupi õigused on määratud <strong>JAH</strong> peale, millest saab uus koguväärtus, sest seda polnud veel määratud (määratud <strong>EI</strong> peale).',
	'TRACE_GROUP_YES_TOTAL_NO_LOCAL'	=> 'Selle grupi õigused selles foorumis on määratud <strong>JAH</strong> peale, millest saab uus koguväärtus, sest seda polnud veel määratud (määratud <strong>EI</strong> peale).',

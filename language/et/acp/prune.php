...
$lang = array_merge($lang, array(
	'ACP_PRUNE_USERS_EXPLAIN'	=> 'Siin leheküljel on Sul võimalik kustutada (või siis deaktiveerida) kasutajaid oma foorumis. Selleks on loodud erinevad viisid, kuidas seda teha, näiteks: postituse arvu, aktiivsuse järgi jne. Iga sellist kriteeriumit saab kombineerida, näiteks on sul võimalik kärpida kasutajaid enne 2002-01-01, kellel on olnud vähem postitusi kui 10. Alternatiivselt saad sa kirjutada kasutajaid siia tekstikasti ja kõik kriteeriumid ignoreeritakse. Ole ettevaatlik siin. Kui kasutaja on kustutatud, siis teda tagasi enam ei saa.',

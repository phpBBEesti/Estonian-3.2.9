...
$lang = array_merge($lang, array(
	...
	'FULLTEXT_MYSQL_NOT_SUPPORTED'			=> 'MySQL fulltext indekseid saab kasutada ainult koos MyISAM või InnoDB tabelitega. MySQL 5.6.4 või sellest kõrgem on nõutud fulltext indeksite InnoDB tabelites.',
	...
	'FULLTEXT_SPHINX_DATA_PATH_EXPLAIN'		=> 'Kasutatakse, et salvestada indeksite ja logi faile. You should create this directory outside the web accessible directories. (should have a trailing slash)',
	...
	'SEARCH_INDEX_DELETE_REDIRECT'			=> array(
		2	=> 'Kõik postitused kuni ID\'ni %2$d on eemaldatud otsingu indeksist, millest %1$d postitused olid selles etapis.<br',
	),
    	'SEARCH_INDEX_DELETE_REDIRECT_RATE'		=> array(
		2	=> 'Hetkel kustutamise kiirus ligikaudu %1$.1f postitusi sekundis.<br />Valmistamine lõpetatakse…',
	),
	...
	'SEARCH_INTERVAL_EXPLAIN'				=> 'Arv sekundites, mis on otsingute intervall kasutajale. See intervall on eraldi igale kasutajale.',

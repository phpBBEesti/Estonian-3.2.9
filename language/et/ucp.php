...
$lang = array_merge($lang, array(
	...
	'ATTACHMENT_LOCKED'				=> 'See teema on lukustatud ja manust ei saa kustutada.',
	...
	'AVATAR_EXPLAIN'				=> 'Maksimaalsed mõõtmed; laius: %1$s, kõrgus: %2$s, faili suurus: %3$.2f KiB.',
	...
	'BOARD_DATE_FORMAT_EXPLAIN'	=> 'Süntaks on sama, mis PHP\'l <a href="https://secure.php.net/manual/function.date.php">date()</a>.',
	...
	'FIELD_TOO_LONG'					=> array(
		1	=> 'The field “%2$s” on liiga pikk, maksimaalselt %1$d sümbol on lubatud.',
		2	=> 'The field “%2$s” on liiga pikk, maksimaalselt %1$d sümbolit on lubatud.',
	),
	...
	'FIELD_INVALID_CHARS_INVALID'		=> 'Väljal “%s” lubamatuid sümboleid.',
	...
	'FULL_FOLDER_OPTION_CHANGED'=> 'Kausta täidetav toiming on edukalt muudetud.',
	...
	'GRAVATAR_AVATAR_EMAIL_EXPLAIN'	=> 'Sisesta oma e-postiaadress, mida sa kasutasid kasutajakonto loomiseks <a href="http://www.gravatar.com/">Gravatar.com</a> keskkonnas.',
	...
	'INVALID_EMOJIS_USERNAME'	=> 'Kasutajanimi sisaldab keelatud sümboleid (Emotikonid).',
	...
	'LOGIN_KEY'					=> 'Sisenemise võtmed',
	'LOGIN_TIME'				=> 'Sisenemise aeg',
	'LOGIN_REDIRECT'			=> 'Oled edukalt sisse logitud.',
	'LOGOUT_FAILED'				=> 'Teid ei logitud välja, kuna taotlus ei vastanud teie seansile. Kui teil endiselt probleeme tekib, võtke ühendust foorumi administraatoriga.',
	...
	'MESSAGE_REPORTED_MESSAGE'		=> 'Raporteeritud sõnum',
	'MESSAGE_SENT_ON'				=> '',
	...
	'NOTIFICATION_METHOD_BOARD'							=> 'Teated',
	...
	'NO_AUTH_PRINT_MESSAGE'			=> 'Teil pole lubatud privaatsõnumeid printida.',
	...
	'EMAIL_NOT_UNIQUE'			=> 'Teie sisestatud e-posti aadressi kasutavad mitmed kasutajad. Peate ka määrama kasutajanime.',
	...
	'PASSWORD_UPDATED_IF_EXISTED'	=> 'Kui teie konto on meil olemas, siis saadati teie kontoga seotud e-posti aadressile uus parool. Kui te ei saad vastavat e-posti, võib see olla sellepärast, et teie kasutajakonto on keelatud, teie konto pole aktiveeritud või teil pole lubatud oma parooli muuta. Kui teil esineb mõni nendest põhjustest, võtke ühendust foorumi administraatoriga. Samuti kontrollige oma rämpsposti filtrit.',
	...
	'PROFILE_INFO_NOTICE'		=> 'Pane tähele! See informatsioon võib olla juba vaadatav samuti teistele kasutajatele. Ole ettevaatlik, kui lisad isiklikke andmeid. Kõik väljad, mis on tähistatud tärniga (*), tuleb täita.',
	...
	'REPLY_TO_ALL'						=> 'Vasta saatjale ja kõikidele adressaatidele.',
	...
	'SEARCH_YOUR_POSTS'			=> 'Näita oma postitusi',
	...
	'UCP_EMAIL_ACTIVATE'		=> 'Pidage meeles, et enne konto aktiveerimist peate sisestama kehtiva e-posti aadressi! Te saate teate antud e-posti aadressile, mis sisaldab konto aktiveerimise linki.',
	...
	'UCP_WELCOME'					=> 'Tere tulemast Kasutaja Juhtpaneeli (KJP). Siit saad sa vaadata ja uuendada oma profiili, valikuid ja tellimusi. Saad saata ka sõnumid teistele kasutajatele, kui see on lubatud. Loe läbi teadaanded enne, kui jätkad.',
	...
	'USERNAME_TAKEN_USERNAME'		=> 'Teie sisestatud kasutajanimi on juba kasutusel, palun valige midagi muud.',
	'USERNAME_DISALLOWED_USERNAME'	=> 'Teie sisestatud kasutajanimi on keelatud või sisaldab keelatud sõna. Palun vali teine nimi.',

...
$lang = array_merge($lang, array(
	...
	'ATTACH_COMMENT_NO_EMOJIS'	=> 'Manuse kommentaar sisaldab keelatud tähemärki (emotikonid).',
	...
	'BUMP_ERROR'				=> 'Sa ei saa tõstada teemat nii kiiresti peale viimast postitust.',
	...
	'DELETE_POST_PERMANENTLY_CONFIRM'	=> 'Kas oled kindel, et soovid selle postituse kustutada <strong>jäädavalt</strong>?',
	'DELETE_POST_PERMANENTLY'	=> array(
		1	=> 'Kustuta postitus jäädavalt, et seda ei saaks taastada',
		2	=> 'Kustuta postitused %1$d jäädavalt, et neid ei saaks taastada',
	),
	...
	'DELETE_TOPIC_PERMANENTLY'	=> array(
		1	=> 'Kustuta see teema jäädavalt, et seda ei saaks taastada',
		2	=> 'Kustuta antud %1$d teemad jäädavalt, et neid ei saaks taastada',
	),
	...
	'LOGIN_EXPLAIN_BUMP'		=> 'Pead sisse logima, et siin foorumis teemat tõstada.',
	'LOGIN_EXPLAIN_DELETE'		=> 'Pead sisse logima, et siin foorumis postitusi kustutada.',
	'LOGIN_EXPLAIN_SOFT_DELETE'	=> 'Selle foorumi postituste kustutamiseks peate sisse logima.',
	...
	'NO_TEMP_DIR'				=> 'Ajutist kausta ei leitud või pole kirjutatav.',

	'PARTIAL_UPLOAD'			=> 'Fail laaditi üles vaid osaliselt.',
	'PHP_UPLOAD_STOPPED'		=> 'PHP laiend peatas faili üleslaadimise.',
	...
	'POLL_TITLE_COMP_TOO_LONG'	=> 'Hääletuse pealkirja suurus on liiga suur, eemaldage BBkoodid või emaotikonid.',
	...
	'POST_CONFIRMATION'			=> 'Postituse kinnitamine',
	...
	'POST_STORED_MOD'			=> 'Sõnum postitati edukalt, kuid enne kui see avalikuks nähtavaks muutub peab selle moderaator heaks kiitma.',
	...
	'SAVE_DRAFT_CONFIRM'		=> 'Pange tähele, et mustandid sisaldavad ainult pealkirja ja sõnumit, kõik muu eemaldatakse. Kas Sa soovid oma mustandit salvestada?',
	'SMILIES'					=> 'Emotikonid',
	'SMILIES_ARE_OFF'			=> 'Emotikonid on <em>VÄLJAS</em>',
	'SMILIES_ARE_ON'			=> 'Emotikonid on <em>SEES</em>',
	'STICKY_ANNOUNCE_TIME_LIMIT'=> 'Kleebise/teadaande/üldteadaande ajalimiit',
	'STICK_TOPIC_FOR'			=> 'Teemat hoitakse kleebisena',
	'STICK_TOPIC_FOR_EXPLAIN'	=> 'Sisesta 0 või jäta tühjaks ajalimiidita kleebise/teadaande/üldteadande jaoks. See number määratakse suhtes postituse ajaga.',
